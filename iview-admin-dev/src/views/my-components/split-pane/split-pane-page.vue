                ...
                <split-pane :style="{height: '100%'}" right min="100px" :max="80" @on-trigger-moving="handleMoving"
                    ...
                    <div slot="left" style="height: 100%;">
                        <split-pane :style="{height: '100%'}" direction="vertical" v-model="triggerOffsetV">
                            <div class="introduce-left-con" slot="top"
                                ...
                                <h5>
                                    -- 需要给trigger绑定mousedown事件，绑定的方法调用this.$refs.pane.handleMousedow(e)，e为mousedown事件的事件对象</h5>
                                <h5>
                                    -- 给trigger添加:style="{width: offset + '%'}"，这里的offset是通过v-model给split-pane组件绑定的值</h5>
                                <h4>- 其他api请看源码</h4>
                            </div>
                            <div slot="bottom" style="background: #A2EDB6;height: 100%;">
                                <split-pane ref="pane" :style="{height: '100%'}" direction="horizontal"
